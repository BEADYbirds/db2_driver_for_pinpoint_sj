...
public class WrappedConnection implements Connection {
    ...
    protected WrappedDB2Statement wrapStatement(Statement s, String ref)
    {
        String transaction = getTransactionIdentifier();
        return new WrappedDB2Statement(s, ref, transaction, this);
    }
    ...
    protected WrappedDB2PreparedStatement wrapPreparedStatement(String sql, String ref, PreparedStatement prepareStatement)
    {
        String transactionIdentifier = getTransactionIdentifier();
        return new WrappedDB2PreparedStatement(prepareStatement, sql, ref, transactionIdentifier,this);
    }
    ...
    public final CallableStatement prepareCall(String sql) throws SQLException {
		...
		if (wrappingEnabled) {
			...
			CallableStatement stmt = wrapCallableStatement(sql, ref, (DB2CallableStatement) prepareCall);
			JdbcProfiler.getInstance().stop(JdbcProfiler.OP_PREPARE, ref);
			return stmt;
		}
		return prepareCall;
    ...
    protected WrappedDB2CallableStatement wrapCallableStatement(String sql, String ref, DB2CallableStatement prepareCall)
    {
        String transactionIdentifier = getTransactionIdentifier();
        return new WrappedDB2CallableStatement(prepareCall,
